...
export const CheckoutStep3 = ({ prevStep, currentStep }) => {
  ...
  const handlePlaceOrder = () => {
    // Aqui você pode também enviar o pedido para o servidor, etc.
    setOrderPlaced(true);
  };
  ...
  return (
    <div>
      {!orderPlaced ? (
        <>
          <h3 className="font-dm text-gray-800 text-lg mb-4">
            Payment Information
          </h3>
          <div>
            <div className="flex items-center justify-between">
              <h4 className="font-dm text-lg">Credit Card</h4>
              <p className="flex items-center gap-2">
                Secure Payment <LuShield className="text-green-500 w-5 h-5" />
              </p>
            </div>
            <div>
        ...
        <div className="my-6 p-4 rounded-lg text-center shadow-md shadow-black/20">
